...
namespace BusinessLayer.DetailsPeople
{
    public class ClsPerson : IPerson
    {
        ...
        private ClsPerson(int? iD, string firstName, string lastName, DateTime birthDay, byte age, 
            int countryID, int contactInformation, int? paymentInformation, string additionalNotes)
        {
            this.ID = iD;
        ...
        {
            string FirstName = string.Empty, LastName = string.Empty, AddtitionalNotes = string.Empty;
        ...
        public static ClsPerson FindByFullName(string FirstName, string LastName)
        {
            ...
            string AddtitionalNotes = string.Empty;
            int countryID = -1, contactInformation = -1, ID = -1;
            DateTime birthDay = DateTime.Now;
            int? paymentInformation = null;
            byte age = 0;
